...
describe("#Delete user route", () => {
    ...
    beforeEach(() => {
      route = DeleteUserRoute.create(deleteUserUsecaseMock as unknown as DeleteUserUsecase);
    });
    ...
    it('should return 500 for an unexpected error', async () => {
      ...
      route = DeleteUserRoute.create(getUserUsecaseErrorMock as unknown as DeleteUserUsecase);
      const req = httpMocks.createRequest({
        method: 'DELETE',
        url: '/user/3',
        params: {

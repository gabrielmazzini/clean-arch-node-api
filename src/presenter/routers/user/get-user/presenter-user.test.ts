...
describe("#Get user route", () => {
    ...
    beforeEach(() => {
      route = GetUsersRoute.create(getUserUsecaseMock as unknown as GetUserUsecase);
    });
    ...
    it('should return 500 for an unexpected error', async () => {
      ...
      route = GetUsersRoute.create(getUserUsecaseErrorMock as unknown as GetUserUsecase);
      const req = httpMocks.createRequest({
        method: 'GET',
        url: '/user/3',
        params: {
